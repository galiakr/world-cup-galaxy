...
export const TRANSLATIONS = {
  en: {
    ...
    home_goals: 'goals',
    scorer_games: 'games',
    scorers_show_all: 'Show all scorers',
    scorers_search: 'Find a player…',
    scorers_no_results: 'No players found',
    scorers_one_goal: '1 goal',
    scorers_players: 'players',
    next_wc_title: 'See you at World Cup 2030!',
    next_wc_sub: 'Spain, Portugal & Morocco · summer 2030 · celebrating 100 years of the World Cup',
  ...
  he: {
    ...
    home_goals: 'שערים',
    scorer_games: 'משחקים',
    scorers_show_all: 'הצגת כל הכובשים',
    scorers_search: 'חפשו שחקן…',
    scorers_no_results: 'לא נמצאו שחקנים',
    scorers_one_goal: 'שער אחד',
    scorers_players: 'שחקנים',
    next_wc_title: 'נתראה במונדיאל 2030!',
    next_wc_sub: 'ספרד, פורטוגל ומרוקו · קיץ 2030 · חוגגים 100 שנים למונדיאל',
    ...
    team_founded: 'נוסדה בשנת',
    team_colors: 'צבעי הנבחרת',
    squad_age: 'בן',
